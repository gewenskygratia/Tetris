...
#list of all 7 tetris figures described using coordinates
...
score, lines= 0, 0
scores= scores = {0: 0, 1: 100, 2: 300, 3: 700, 4: 1500}


#Checks if we are at borders of grid 
def check_borders():
